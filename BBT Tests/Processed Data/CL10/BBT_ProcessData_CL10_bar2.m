...
dbl = 0.7115;        % Diameter of rebar, in
BarDia = 25.4*dbl;  % Diameter of rebar, mm
Ab = (pi/4)*dbl^2;  % area of rebars, in2

PrintLocation = 'C:\ConditionDependentPBEE\ExperimentalProgram\BBT Tests\Processed Data\CL10\bar';
addpath('C:\ConditionDependentPBEE\ExperimentalProgram\BBT Tests\Raw Data\CL10\MTS')
addpath('C:\ConditionDependentPBEE\ExperimentalProgram\BBT Tests\Raw Data\CL10\Optotrack\CDPBEE_corrosion_2021_12_06_141652');

filename1 = ['CDPBEE_corrosion_2021_12_06_132308_0',(OTfile1),'_3d.xls'];     % name of Optotrak data file - push
filename2 = ['CDPBEE_corrosion_2021_12_06_132308_0',(OTfile2),'_3d.xls'];     % name of Optotrak data file - pull
