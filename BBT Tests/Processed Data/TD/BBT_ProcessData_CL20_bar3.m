...
dbl = 0.5;        % Diameter of rebar, in
BarDia = 25.4*dbl;  % Diameter of rebar, mm
Ab = (pi/4)*dbl^2;  % area of rebars, in2

PrintLocation = 'C:\ConditionDependentPBEE\ExperimentalProgram\BBT Tests\Processed Data\TD\bar';
addpath('C:\ConditionDependentPBEE\ExperimentalProgram\BBT Tests\Raw Data\TD\MTS')
addpath('C:\ConditionDependentPBEE\ExperimentalProgram\BBT Tests\Raw Data\TD\Optotrack\TD_BBT_2022_03_03_140654');

filename1 = ['TD_BBT_2022_03_03_140654_0',(OTfile1),'_3d.xls'];     % name of Optotrak data file - push
filename2 = ['TD_BBT_2022_03_03_140654_0',(OTfile2),'_3d.xls'];     % name of Optotrak data file - pull
filename3 = ['td_bbt_',num2str(BarNum),'_comp.txt'];                              % name of MTS data file - push
filename4 = ['td_bbt_',num2str(BarNum),'_tension.txt'];                              % name of MTS data file - pulls                              % name of MTS data file - pulls 
header1 = 5;                            % number of header lines to skip in Optotrak
header2 = 8;                            % number of header lines to skip in MTS file
np = 9;                                 % number of Optotrak sensors
