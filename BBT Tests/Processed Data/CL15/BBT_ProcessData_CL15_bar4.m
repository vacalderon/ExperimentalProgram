...
addpath('C:\ConditionDependentPBEE\ExperimentalProgram\BBT Tests\Raw Data\CL15\MTS')
addpath('C:\ConditionDependentPBEE\ExperimentalProgram\BBT Tests\Raw Data\CL15\Optotrack\CDPBEE_corrosion_2021_12_07_094712');
...
filename3 = ['bbt_15_',num2str(BarNum),'_comp.txt'];                              % name of MTS data file - push
filename4 = ['bbt_15_',num2str(BarNum),'_tension.txt'];                              % name of MTS data file - pulls                              % name of MTS data file - pulls 
