...
spectrum_file = r'CL10_D_000_Spectrum_1.txt'


with open(spectrum_file) as datafile:
    data = datafile.readlines()[56:-1]
...
plt.plot(energy,counts,color="#d94545")
plt.xlim(0,10)
plt.ylim(0,25e3)
plt.xlabel('Energy (keV)', fontsize=11)
plt.ylabel('Counts', fontsize=11)
plt.tick_params(direction='out',axis='both',labelsize=10)
plt.text(0.277-0.15, c_counts, "C")      #OXINSTLABEL: 6, 0.277, C
plt.text(0.615-0.215, fe1_counts, "Fe")   #OXINSTLABEL: 26, 0.615, Fe
plt.text(0.703, fe2_counts, "Fe")   #OXINSTLABEL: 26, 0.703, Fe
plt.text(6.404, fe3_counts, "Fe")   #OXINSTLABEL: 26, 6.404, Fe
plt.text(7.058, fe4_counts,"Fe")    #OXINSTLABEL: 26, 7.058, Fe
plt.text(5.899, Mn1_counts, "Mn")   #OXINSTLABEL: 25, 5.899, Mn
...
plt.text(1.740, Si_counts, "Si")    #OXINSTLABEL: 14, 1.740, Si
plt.text(2.308, S1_counts , "S")    #OXINSTLABEL: 16, 2.308, S
#plt.text(2.464, S2_counts, "S")     #OXINSTLABEL: 16, 2.464, S
plt.text(5.416,Cr1_counts, "Cr")    ##OXINSTLABEL: 24, 5.415, Cr
...
plt.text(4.952, V1_counts, "V")     ##OXINSTLABEL: 23, 4.952, V
#plt.text(5.427, V2_counts, "V")     ##OXINSTLABEL: 23, 5.427, V
plt.text(0.511, V3_counts, "V")     ##OXINSTLABEL: 23, 0.511, V
